...
public class Main3Activitymalai extends AppCompatActivity {
 ...
 //   private FirebaseFirestore firebaseFirestore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date=(EditText)findViewById(R.id.ed5) ;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               target=targeted.getText().toString();
                ...
                {
                    Toast.makeText(Main3Activitymalai.this,"Plaese enter the Branch Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activitymalai.this,"Plaese fill the Event Name",Toast.LENGTH_LONG).show();
                }
                ...
                {
                    Toast.makeText(Main3Activitymalai.this,"Plaese Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
