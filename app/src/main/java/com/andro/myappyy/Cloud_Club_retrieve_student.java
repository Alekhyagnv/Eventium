...
public class Cloud_Club_retrieve_student extends AppCompatActivity {
    RecyclerView eventslist;
    DatabaseReference reference;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cloud__club_retrieve_student);
        eventslist = (RecyclerView) findViewById(R.id.recyclerviewcc_student);
    ...
    private void validateeventslist() {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("Clubs").child("Cloud Club");

        FirebaseRecyclerAdapter<Events,Cloud_Club_retrieve_student.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events,Cloud_Club_retrieve_student.eventslistviewholder>
                (
                        Events.class,R.layout.events_info, Cloud_Club_retrieve_student.eventslistviewholder.class,reference
                ) {
            @Override
            protected void populateViewHolder(Cloud_Club_retrieve_student.eventslistviewholder viewHolder, Events model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Cloud_Club_retrieve_student.this,Android_details_student.class);
