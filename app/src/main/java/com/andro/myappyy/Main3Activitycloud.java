...
public class Main3Activitycloud extends AppCompatActivity {
    ...
    private EditText eventname,dateed,targeted,info,link,olink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postref= FirebaseDatabase.getInstance().getReference().child("Clubs").child("Cloud Club");
        eventname=(EditText)findViewById(R.id.edcceventname) ;
        dateed=(EditText)findViewById(R.id.edccdate) ;
        targeted=(EditText)findViewById(R.id.edcctarget) ;
        uploadBtn1=(Button)findViewById(R.id.bccupload);
        info=(EditText)findViewById(R.id.edccprofile);
        link=(EditText)findViewById(R.id.edcclink);

        save=(Button)findViewById(R.id.bccinsert);
        profile=(ImageView)findViewById(R.id.imgcc) ;
        olink=findViewById(R.id.edcclink1);
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activitycloud.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                link2=olink.getText().toString();
                if(TextUtils.isEmpty(event))
                {
                    Toast.makeText(Main3Activitycloud.this,"Please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activitycloud.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activitycloud.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activitycloud.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activitycloud.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activitycloud.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    StorageReference filepath=storageReference.child("cloudimages").child(postdate+posttime+".jpg");

                    final StorageReference thumb_filepath=storageReference.child("cloudimages").child(postdate+posttime+".jpg");
        ...
        postref.child(uid).updateChildren(postmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(Main3Activitycloud.this,Main3Activitycloud_retrieve.class);
                ...
                else
                {
                    ...
                    Toast.makeText(Main3Activitycloud.this,"Error Occured :"+msg,Toast.LENGTH_LONG).show();
                }
