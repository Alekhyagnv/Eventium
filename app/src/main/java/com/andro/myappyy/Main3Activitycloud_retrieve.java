...
public class Main3Activitycloud_retrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventslist = (RecyclerView) findViewById(R.id.recyclerviewcc);
    ...
    private void validateeventslist() {
        ...
        FirebaseRecyclerAdapter<Events, Main3Activitycloud_retrieve.eventslistviewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Events, Main3Activitycloud_retrieve.eventslistviewholder>
                (
                        Events.class, R.layout.events_info, Main3Activitycloud_retrieve.eventslistviewholder.class, reference
                ) {
            @Override
            protected void populateViewHolder(Main3Activitycloud_retrieve.eventslistviewholder viewHolder, Events model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(Main3Activitycloud_retrieve.this, Android_details_student.class);
