...
public class Main3Activityacm_retrieve extends AppCompatActivity {
    ...
    private void validateeventslist() {
        ...
        FirebaseRecyclerAdapter<Events, Main3Activityacm_retrieve.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events, Main3Activityacm_retrieve.eventslistviewholder>
                (
              ...
              //  final String s6=model.getUid();
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Main3Activityacm_retrieve.this,Android_details.class);
