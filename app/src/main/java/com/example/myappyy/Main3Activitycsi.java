...
FirebaseAuth firebaseAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date=(EditText)findViewById(R.id.edcsidate) ;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activitycsi.this,"Plaese enter the Branch Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activitycsi.this,"Plaese fill the Event Name",Toast.LENGTH_LONG).show();
                }
                ...
                {
                    Toast.makeText(Main3Activitycsi.this,"Plaese Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
