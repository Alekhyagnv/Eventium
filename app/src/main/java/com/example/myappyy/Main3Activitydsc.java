...
public class Main3Activitydsc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date=(EditText)findViewById(R.id.eddscdate) ;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activitydsc.this,"Plaese enter the Branch Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activitydsc.this,"Plaese fill the Event Name",Toast.LENGTH_LONG).show();
                }
                ...
                {
                    Toast.makeText(Main3Activitydsc.this,"Plaese Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
