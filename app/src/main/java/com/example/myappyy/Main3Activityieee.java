...
public class Main3Activityieee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date=(EditText)findViewById(R.id.edieeedate) ;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activityieee.this,"Plaese enter the Branch Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activityieee.this,"Plaese fill the Event Name",Toast.LENGTH_LONG).show();
                }
                ...
                {
                    Toast.makeText(Main3Activityieee.this,"Plaese Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
